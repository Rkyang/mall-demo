...
import com.rky.mall.common.utils.JwtTokenUtil;
import com.rky.mall.dao.UmsAdminRoleRelationDao;
import com.rky.mall.mbg.mapper.UmsAdminMapper;
import com.rky.mall.mbg.model.UmsAdmin;
import com.rky.mall.mbg.model.UmsAdminExample;
...
public class UmsAdminServiceImpl implements UmsAdminService {
    ...
    public UmsAdmin register(UmsAdmin umsAdminParam) {
        ...
        List<UmsAdmin> umsAdmins = umsAdminMapper.selectByExample(example);
        if (umsAdmins.size() > 0) {
            LOGGER.info("用户名已存在：{}", umsAdmin.getUsername());
            return null;
        }
        // 将密码进行加密操作
